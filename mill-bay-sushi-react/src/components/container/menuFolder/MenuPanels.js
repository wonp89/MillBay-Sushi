...
const MenuPanels =  (props) => {
    return  (
            <div>
                <div style={{backgroundImage: 'url(http://www.millbaysushi.com/img/panel.png)'}} className={classes.Menus} onClick={props.click}><p className={classes.listName}>{props.name}</p>
